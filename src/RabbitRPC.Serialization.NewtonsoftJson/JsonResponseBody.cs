...
{
    [DataContract]
    internal class JsonResponseBody : IResponseMessageBody
    {
        [DataMember]
        ...
        {
            return Helpers.EnsureObjectType(_byRefParameters[paramName], targetType);
        }

        public object? GetReturnValue(Type targetType)
        {
            return Helpers.EnsureObjectType(_returnValue,targetType);
        }
